...
@dataclass
class SelfContactLoss(Loss):
    geothres: float = 0.3
    euclthres: float = 0.2
    model_type: str = "smplx"
    inside_loss_weight: float = 0.5
    outside_loss_weight: float = 0.0
...
class Losses:
    ...
    custom: CustomLoss = CustomLoss(type="custom")
    self_contact: SelfContactLoss = SelfContactLoss(type="self_contact")
