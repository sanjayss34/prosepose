...
class FlickrCI3D_Signatures:
    ...
    custom_losses_path: str = ''
    processed_pkl_extension: str = '_optimization.pkl'
...
class Demo:
    ...
    humans_per_example: int = 2
    largest_bbox_only: bool = False
    center_bbox_only: bool = False
    hmr2: bool = False
    write_processed_path: str = ''
    best_match_with_bev_box: bool = False
